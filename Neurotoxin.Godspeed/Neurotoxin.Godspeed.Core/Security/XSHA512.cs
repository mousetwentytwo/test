...
namespace Neurotoxin.Godspeed.Core.Security {
    ...
    public static class XSHA512 {
        ...
        public static string GetXSHA512(this Neurotoxin.Godspeed.Core.Net.FtpClient client, string path) {
            FtpReply reply;
        ...
        public static IAsyncResult BeginGetXSHA512(this Neurotoxin.Godspeed.Core.Net.FtpClient client, string path, AsyncCallback callback, object state) {
