...
namespace Neurotoxin.Godspeed.Core.Security {
    ...
    public static class XSHA256 {
        ...
        public static string GetXSHA256(this Neurotoxin.Godspeed.Core.Net.FtpClient client, string path) {
            FtpReply reply;
        ...
        public static IAsyncResult BeginGetXSHA256(this Neurotoxin.Godspeed.Core.Net.FtpClient client, string path, AsyncCallback callback, object state) {
