...
namespace Neurotoxin.Godspeed.Core.Security {
    ...
    public static class XMD5 {
        ...
        public static string GetXMD5(this Neurotoxin.Godspeed.Core.Net.FtpClient client, string path) {
            FtpReply reply;
        ...
        public static IAsyncResult BeginGetXMD5(this Neurotoxin.Godspeed.Core.Net.FtpClient client, string path, AsyncCallback callback, object state) {
