...
namespace AC.AvalonControlsLibrary.Controls
{
    ...
    public class TimePicker : Control
    {
        ...
        /// <summary>
        /// Gets or sets if seconds should shown or not
        /// </summary>
        ...
        /// <summary>
        /// Backing store for ShowSeconds
        /// </summary>
        public static readonly DependencyProperty ShowSecondsProperty =
            DependencyProperty.Register("ShowSeconds", typeof(bool), typeof(TimePicker), new UIPropertyMetadata(false, null));
