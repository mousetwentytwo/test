...
namespace SpreadsheetLight.Charts
{
    ...
    public class SLPlotArea
    {
        ...
        public void SetAxisData(string WorksheetName, int StartRowIndex, int StartColumnIndex, int EndRowIndex, int EndColumnIndex)
        {
            foreach (var series in DataSeries)
            {
                series.AxisData.StringReference.Formula = SLChartTool.GetChartReferenceFormula(WorksheetName, StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex);
            }
        }
