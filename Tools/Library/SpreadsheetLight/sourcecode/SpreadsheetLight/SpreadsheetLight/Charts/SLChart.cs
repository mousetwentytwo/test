...
namespace SpreadsheetLight.Charts
{
    ...
    /// </summary>
    internal enum SLStockChartType
    {
        /// <summary>
        /// High-Low-Close.
        /// </summary>
    ...
    public class SLChart
    {
        ...
        internal void SetPlotAreaAxes()
        {
            ...
            this.PlotArea.PrimaryValueAxis.FormatCode = "General";
            ...
            this.PlotArea.SecondaryValueAxis.FormatCode = "General";
        ...
        /// </summary>
        /// <returns>An SLPieChartOptions class with theme information.</returns>
        public SLPieChartOptions CreatePieChartOptions()
        {
            return new SLPieChartOptions(this.listThemeColors);
        }
