...
namespace SpreadsheetLight
{
    public partial class SLDocument
    {
        ...
        public SLC.SLChart CreateChart(string StartCellReference, string EndCellReference)
        {
            ...
            return this.CreateChartInternal(gsSelectedWorksheetName, iStartRowIndex, iStartColumnIndex, iEndRowIndex, iEndColumnIndex, null, false);
        }

        /// <summary>
        /// Creates an instance of SLChart, given cell references of opposite cells in a cell range and whether rows or columns contain the data series and if hidden data is used.
        /// </summary>
        /// <param name="StartCellReference">The cell reference of the start cell of the cell range to be in the chart, such as "A1". This is typically the top-left cell.</param>
        /// <param name="EndCellReference">The cell reference of the end cell of the cell range to be in the chart, such as "A1". This is typically the bottom-right cell.</param>
        ...
        public SLC.SLChart CreateChart(string StartCellReference, string EndCellReference, bool RowsAsDataSeries, bool ShowHiddenData)
        {
            ...
            return this.CreateChartInternal(gsSelectedWorksheetName, iStartRowIndex, iStartColumnIndex, iEndRowIndex, iEndColumnIndex, RowsAsDataSeries, ShowHiddenData);
        }
        ...
        public SLC.SLChart CreateChart(string WorksheetName, string StartCellReference, string EndCellReference)
        {
            ...
            return this.CreateChartInternal(WorksheetName, iStartRowIndex, iStartColumnIndex, iEndRowIndex, iEndColumnIndex, null, false);
        }

        /// <summary>
        /// Creates an instance of SLChart, given cell references of opposite cells in a cell range and whether rows or columns contain the data series.
        /// </summary>
        /// <param name="WorksheetName">The name of the source worksheet.</param>
        /// <param name="StartCellReference">The cell reference of the start cell of the cell range to be in the chart, such as "A1". This is typically the top-left cell.</param>
        /// <param name="EndCellReference">The cell reference of the end cell of the cell range to be in the chart, such as "A1". This is typically the bottom-right cell.</param>
        ...
        public SLC.SLChart CreateChart(string WorksheetName, string StartCellReference, string EndCellReference, bool RowsAsDataSeries, bool ShowHiddenData)
        {
            ...
            return this.CreateChartInternal(WorksheetName, iStartRowIndex, iStartColumnIndex, iEndRowIndex, iEndColumnIndex, RowsAsDataSeries, ShowHiddenData);
        }
        ...
        {
            return this.CreateChartInternal(gsSelectedWorksheetName, StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex, null, false);
        }

        /// <summary>
        /// Creates an instance of SLChart, given row and column indices of opposite cells in a cell range and whether rows or columns contain the data series and if hidden data is used.
        /// </summary>
        /// <param name="StartRowIndex">The row index of the start row. This is typically the top row.</param>
        /// <param name="StartColumnIndex">The column index of the start column. This is typically the left-most column.</param>
        /// <param name="EndRowIndex">The row index of the end row. This is typically the bottom row.</param>
        ...
        {
            return this.CreateChartInternal(gsSelectedWorksheetName, StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex, RowsAsDataSeries, ShowHiddenData);
        }
        ...
        {
            return this.CreateChartInternal(WorksheetName, StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex, null, false);
        }
        ...
        {
            return this.CreateChartInternal(WorksheetName, StartRowIndex, StartColumnIndex, EndRowIndex, EndColumnIndex, RowsAsDataSeries, ShowHiddenData);
        }
        ...
        private List<SLC.SLDataSeries> FillChartDataSeries(string WorksheetName, int StartRowIndex, int StartColumnIndex, int EndRowIndex, int EndColumnIndex, bool RowsAsDataSeries, bool ShowHiddenData)
        {
            ...
            if (WorksheetName.Equals(gsSelectedWorksheetName, StringComparison.InvariantCultureIgnoreCase))
            {
                bFound = false;
            }
            else
            {
                ...
                {
                    if (sheet.Name.Equals(WorksheetName, StringComparison.InvariantCultureIgnoreCase))
                    {
                        bFound = true;
            ...
            if (RowsAsDataSeries)
            {
                ...
                for (i = StartRowIndex + 1; i <= EndRowIndex; ++i)
                {
                    if (HiddenRows.ContainsKey(i) && !HiddenRows[i])
                    {
                        ...
                        nr.NumberingCache.FormatCode = "General";
                        index2 = 0;
                        for (j = StartColumnIndex + 1; j <= EndColumnIndex; ++j)
                        {
                            if (HiddenColumns.ContainsKey(j) && !HiddenColumns[j])
