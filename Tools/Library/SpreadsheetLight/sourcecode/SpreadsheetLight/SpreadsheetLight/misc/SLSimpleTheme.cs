...
namespace SpreadsheetLight
{
    ...
    internal class SLSimpleTheme
    {
        ...
        internal void CalculateRowColumnInfo()
        {
            ...
            // This is tested for all 29 typefaces of the 53 built-in themes at both
            // 96 DPI and 120 DPI.
            ...
            // What are the 29 typefaces? Alright fine...
            // Arial, Arial Black, Arial Narrow, Bodoni MT Condensed, Book Antiqua, Bookman Old Style,
            // Calibri, Cambria, Candara, Century Gothic, Century Schoolbook, Consolas, Constantia,
            // Corbel, Franklin Gothic Book, Franklin Gothic Medium, Garamond, Georgia, Gill Sans MT,
            // Impact, Lucida Sans, Lucida Sans Unicode, Palatino Linotype, Perpetua, Rockwell,
            // Times New Roman, Trebuchet MS, Tw Cen MT, and *grrr* Verdana
            ...
            using (System.Drawing.Bitmap bmGraphics = new System.Drawing.Bitmap(iBitmapWidth, iBitmapHeight))
            {
                ...
                if (this.MinorLatinFont.Equals("Verdana", StringComparison.InvariantCultureIgnoreCase))
                {
                    // this is for 96 DPI
