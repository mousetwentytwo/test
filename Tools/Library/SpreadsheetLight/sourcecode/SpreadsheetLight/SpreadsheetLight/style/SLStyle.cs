...
namespace SpreadsheetLight
{
    ...
    public class SLStyle
    {
        ...
        {
            if (NewStyle.HasAlignment) this.Alignment = NewStyle.Alignment;
            if (NewStyle.HasProtection) this.Protection = NewStyle.Protection;
            if (NewStyle.HasNumberingFormat) this.FormatCode = NewStyle.FormatCode;
            if (NewStyle.HasFont) this.Font = NewStyle.Font;
            if (NewStyle.HasFill) this.Fill = NewStyle.Fill;
            if (NewStyle.HasBorder) this.Border = NewStyle.Border;
        }
