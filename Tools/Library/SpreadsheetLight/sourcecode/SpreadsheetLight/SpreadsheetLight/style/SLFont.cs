...
namespace SpreadsheetLight
{
    ...
    public class SLFont
    {
        ...
        internal Font ToFont()
        {
            ...
            if (this.Bold != null) f.Bold = new Bold();
            if (this.Italic != null) f.Italic = new Italic();
            if (this.Strike != null) f.Strike = new Strike();
            if (this.Outline != null) f.Outline = new Outline();
            if (this.Shadow != null) f.Shadow = new Shadow();
            if (this.Condense != null) f.Condense = new Condense();
            if (this.Extend != null) f.Extend = new Extend();
