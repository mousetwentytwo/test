...
{
    internal class SLCell
    {
        //internal CellFormula Formula { get; set; }
        internal SLCellFormula CellFormula { get; set; }
        ...
        // NumericValue. We'll actually use NumericValue if CellText isn't null.
        ...
        internal CellValues DataType { get; set; }
