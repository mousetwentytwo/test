...
namespace SpreadsheetLight
{
    ...
    internal class SLColumnProperties
    {
        ...
        internal bool IsEmpty
        {
            get
            {
                return (this.HasWidth == false) && (this.StyleIndex == 0) && (this.Hidden == false) && (this.BestFit == false) && (this.Phonetic == false) && (this.OutlineLevel == 0) && (this.Collapsed == false);
            }
        }
        ...
        internal string ToHash()
        {
            ...
            sb.AppendFormat("{0},", this.Width);
            sb.AppendFormat("{0},", this.StyleIndex);
            sb.AppendFormat("{0},", this.Hidden);
            sb.AppendFormat("{0},", this.BestFit);
            sb.AppendFormat("{0},", this.Phonetic);
            sb.AppendFormat("{0},", this.OutlineLevel);
