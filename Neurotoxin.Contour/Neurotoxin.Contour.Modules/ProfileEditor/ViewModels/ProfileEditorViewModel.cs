...
namespace Neurotoxin.Contour.Modules.ProfileEditor.ViewModels
{
    /// <summary>
    ...
    public class ProfileEditorViewModel : ModuleViewModelBase
    {
        ...
        private void Initialize()
        {
            ...
            ConsoleId = _profile.ConsoleId.ToHex();
            ProfileId = _profile.ProfileId.ToHex();
        ...
        private ImageSource GetThumbnail(byte[] image)
        {
            ...
            {
                return null;
                //return new BitmapImage(new Uri("pack://application:,,,/Neurotoxin.Contour.Modules;component/Resources/hidden_achivement.png"));
            }
