...
using Neurotoxin.Contour.Modules.HexViewer.Controls;
using Neurotoxin.Contour.Modules.HexViewer.ViewModels;
using Neurotoxin.Contour.Presentation.Infrastructure;
using Rectangle = System.Windows.Shapes.Rectangle;

namespace Neurotoxin.Contour.Modules.HexViewer.Views
{
    /// <summary>
